...
> = {
  '1': {
    ...
    item: { de: 'Kugelblitz', en: 'Light Ball', ja: 'でんきだま' },
  },
  '2': {
    pokemon: { de: 'Plinfa', en: 'Piplup', ja: 'ポッチャマ' },
    item: { de: 'Zauberwasser', en: 'Mystic Water', ja: 'しんぴのしずく' },
  },
  '3': {
    pokemon: { de: 'Relaxo', en: 'Snorlax', ja: 'カビゴン' },
    item: { de: 'Überreste', en: 'Leftovers', ja: 'たべのこし' },
  },
  '4': {
    pokemon: { de: 'Glurak', en: 'Charizard', ja: 'リザードン' },
    item: { de: 'Holzkohle', en: 'Charcoal', ja: 'もくたん' },
  },
  '5': {
    pokemon: { de: 'Quajutsu', en: 'Greninja', ja: 'ゲッコウガ' },
    item: { de: 'Seegesang', en: 'Shell Bell', ja: 'かいがらのすず' },
  },
  '6': {
    pokemon: { de: 'Mauzi', en: 'Meowth', ja: 'ニャース' },
    item: { de: 'Münzamulett', en: 'Amulet Coin', ja: 'おまもりこばん' },
  },
  '7': {
    pokemon: { de: 'Bisasam', en: 'Bulbasaur', ja: 'フシギダネ' },
    item: { de: 'Wundersaat', en: 'Miracle Seed', ja: 'きせきのタネ' },
  },
  '8': {
    pokemon: { de: 'Flegmon', en: 'Slowpoke', ja: 'ヤドン' },
    item: { de: 'Nassbrocken', en: 'Damp Rock', ja: 'しめったいわ' },
  },
  '9': {
    pokemon: { de: 'Hydropi', en: 'Mudkip', ja: 'ミズゴロウ' },
    item: { de: 'Pudersand', en: 'Soft Sand', ja: 'やわらかいすな' },
  },
  '10': {
    pokemon: { de: 'Robball', en: 'Popplio', ja: 'アシマリ' },
    item: { de: 'Wassertafel', en: 'Splash Plate', ja: 'しずくプレート' },
  },
  '11': {
    pokemon: { de: 'Bauz', en: 'Rowlet', ja: 'モクロー' },
    item: { de: 'Wiesentafel', en: 'Meadow Plate', ja: 'みどりのプレート' },
  },
  '12': {
    pokemon: { de: 'Flamiau', en: 'Litten', ja: 'ニャビー' },
    item: { de: 'Feuertafel', en: 'Flame Plate', ja: 'ひのたまプレート' },
  },
  '13': {
    pokemon: { de: 'Gengar', en: 'Gengar', ja: 'ゲンガー' },
    item: { de: 'Giftschleim', en: 'Black Sludge', ja: 'くろいヘドロ' },
  },
  '14': {
    pokemon: { de: 'Evoli', en: 'Eevee', ja: 'イーブイ' },
    item: { de: 'Sanftglocke', en: 'Soothe Bell', ja: 'アイテム' },
  },
  '15': {
    pokemon: { de: 'Mimigma', en: 'Mimikyu', ja: 'ミミッキュ' },
    item: { de: 'Bannsticker', en: 'Spell Tag', ja: 'アイテム' },
  },
  '16': {
    pokemon: { de: 'Guardevoir', en: 'Gardevoir', ja: 'サーナイト' },
    item: { de: 'Wahlschal', en: 'Choice Scarf', ja: 'アイテム' },
  },
};

const DECOR_LOCALES: Record<string, LocalizedText> = {
  '1': { de: 'Octillery-Vase', en: 'Octillery Pot', ja: 'オクタンツボ' },
  '2': { de: 'Tuska-Kaktus', en: 'Sudowoodo Bonsai', ja: 'ウソッキー盆栽' },
  '3': { de: 'Starmie-Sprudler', en: 'Starmie Bubbler', ja: 'スターミーシャワー' },
  '5': { de: 'Mogelbaum-Bonsai', en: 'Exeggutor Palm', ja: 'ナッシーツリー' },
  '6': { de: 'Angelverbotsschild', en: 'No-Fishing Sign', ja: 'だいじなかんばん' },
  '8': { de: 'Laterneco-Lampe', en: 'Lampent Lamp', ja: 'ランプラーランプ' },
  '9': { de: 'Parasek-Pilze', en: 'Parasect Puffballs', ja: 'パラセクトダケ' },
  '10': { de: 'Sonnflora-Blumen', en: 'Sunflora Bloom', ja: 'キマワリフラワー' },
  '11': { de: 'Digdri-Stein', en: 'Dugtrio Rock', ja: 'ダグトリオロック' },
  '12': { de: 'Shaymin-Pflanze', en: 'Shaymin Plant', ja: 'シェイミそう' },
  '13': { de: 'Piepi-Puppe', en: 'Clefairy Doll', ja: 'ピッピにんぎょう' },
  '15': { de: 'Delegator-Puppe', en: 'Substitute Plush', ja: 'みがわりぬいぐるみ' },
  '16': { de: 'Elfun-Kissen', en: 'Whimsicott Cushion', ja: 'エルフーンクッション' },
  '17': { de: 'Dressella-Puppe', en: 'Lilligant Doll', ja: 'ドレディアドール' },
  '18': { de: 'Evoli-Bronzefigur', en: 'Bronze Eevee', ja: 'イーブイどうぞう' },
  '20': { de: 'Modell "MS Anne"', en: 'S.S. Anne Model', ja: 'サントアンヌ号もけい' },
  '22': { de: 'Durengard-Figur', en: 'Aegislash Statue', ja: 'ギルガルドオブジェ' },
  '24': { de: 'Kokowei-Palmen', en: 'Cacnea Planter', ja: 'サボネアポット' },
